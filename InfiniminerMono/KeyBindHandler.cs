...
using Buttons = InfiniminerShared.Buttons;
...
namespace InfiniminerMono
{
    public class KeyBindHandler
    {
        ...
        Dictionary<MouseButton, Buttons> mouseBinds = new Dictionary<InfiniminerShared.MouseButton, Buttons>();
        ...
        public void SaveBinds(InfiniminerShared.DatafileWriter output, string filename)
        {
            foreach (Keys key in keyBinds.Keys)
            {
                output.Data[key.ToString()] = keyBinds[key].ToString();
            }
            foreach (InfiniminerShared.MouseButton button in mouseBinds.Keys)
            {
        ...
        {
            mouseBinds.Add(InfiniminerShared.MouseButton.LeftButton, Buttons.Fire);
            ...
            mouseBinds.Add(InfiniminerShared.MouseButton.WheelUp, Buttons.BlockUp);
            mouseBinds.Add(InfiniminerShared.MouseButton.WheelDown, Buttons.BlockDown);
        }
    }
}
